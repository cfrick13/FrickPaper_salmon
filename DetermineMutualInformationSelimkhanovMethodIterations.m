...
function [] = DetermineMutualInformationSelimkhanovMethodIterations(SigFeaturesArray,k,selectedFeatures,dimensions)
...
iterations = 10;
percentageofsamplesize =0.6:0.1:1;
...
%     for cyclenumber = 1:2
        ...
        disp([iter cyclenumber]); %Display cycle to track progress
        ...
        parfor samplingcycle = 1:length(percentageofsamplesize)
        ...
        %             bootresponsesGivenSvector = bootstrp(1,@(x) x,responsesGivenSvector); %cannot perform bootstrap because you end up with duplicate values and an information of -INF
            ...
            infoInUnitsOfBitsMatrix(iter,cyclenumber,samplingcycle,:) = entropydiffR - entropydiffRS;
